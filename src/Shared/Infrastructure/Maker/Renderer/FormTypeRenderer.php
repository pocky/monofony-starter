 ...
 * @internal
 */
final readonly class FormTypeRenderer
{
    ...
    public function render(ClassNameDetails $formClassDetails, array $formFields, ClassNameDetails $boundClassDetails = null, array $constraintClasses = [], array $extraUseClasses = []): void
    {
        ...
        if ($boundClassDetails instanceof \Symfony\Bundle\MakerBundle\Util\ClassNameDetails) {
        ...
        $this->generator->generateClass(
            ...
            [
                ...
                'bounded_class_name' => $boundClassDetails instanceof \Symfony\Bundle\MakerBundle\Util\ClassNameDetails ? $boundClassDetails->getShortName() : null,
                'form_fields' => $fields,
            ],
        );
    }
