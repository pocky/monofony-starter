...
use App\Security\Shared\Infrastructure\Validator\Constraints as CustomConstraints;
...
final class RegisterAppUser
{
    public function __construct(
         ...
         */
        #[NotBlank(message: 'sylius.customer.email.not_blank')] #[Email(
        ...
        #[NotBlank(message: 'sylius.user.plainPassword.not_blank')] #[Length(
            min: 4,
            max: 254,
