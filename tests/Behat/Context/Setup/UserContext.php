...
class UserContext implements Context
{
    public function __construct(
        ...
        private readonly AppUserFactory $appUserFactory,
        private readonly ObjectManager $appUserManager,
    ) {
    }
    ...
    {
        $user = $this->appUserFactory::createOne(['email' => $email, 'password' => $password, 'enabled' => true])
            ->disableAutoRefresh()
        ;
